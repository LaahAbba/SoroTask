      ...
      <main className="container mx-auto px-6 py-12">
        ...
        <section className="mt-16 space-y-6">
          ...
          <PermissionGuard
            ...
            fallback={
              <div className="bg-neutral-800/50 border border-neutral-700/50 rounded-xl p-6 text-center text-neutral-400 shadow-xl">
                <p>You don't have permission to view execution logs.</p>
              </div>
            }
          >
...
export default function Home() {
  return (
    <RouteGuard requiredPermissions={['tasks:read']} redirectTo="/login">
      <HomePage />
    </RouteGuard>
  );
}
